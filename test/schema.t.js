require('proof')(26, okay => {
    ...
    const root = Schema.root(0)
    {
        ...
        okay(pending.createObjectStore('store', null, null), 1, 'create object store')
        ...
        okay(pending.createIndex('store', 'index', 'value', false, false), 2, 'create index')
        ...
        okay(subsequent.createIndex('store', 'index2', 'value', true, true), 3, 'subsequent create index')
